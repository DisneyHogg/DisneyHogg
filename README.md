...
I am also fascinated by how we can apply mathematics to develop our understanding of biology, check out some of my [papers in this area](https://wellcomeopenresearch.org/articles/5-289).

What (coding) problems bug me at the moment?
 - Why is it so [hard](https://doi.org/10.1063/5.0151938) to prove Atiyah's stellar conjecture?
 - If it's taking me a long time to compute a Groebner basis, what should I be changing to speed up the process?

<!--
**DisneyHogg/DisneyHogg** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.

When coding I've worked with
 - Python
 - Julia
 - Maple
 - R
